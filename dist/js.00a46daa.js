...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/html5-qrcode/qrcode.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = getLazarSoftScanner;
...
},{}],"js/html5-qrcode/html5-qrcode.js":[function(require,module,exports) {
"use strict";
...
},{"./qrcode":"js/html5-qrcode/qrcode.js"}],"js/html5-qrcode/html5-qrcode-scanner.js":[function(require,module,exports) {
"use strict";
...
exports.default = Html5QrcodeScanner;
...
},{}],"js/install.js":[function(require,module,exports) {
'use strict';

var deferredInstallPrompt = null;
var installButton = document.getElementById('butInstall');
installButton.addEventListener('click', installPWA); // Add event listener for beforeinstallprompt event
...
function installPWA(evt) {
  ...
  evt.srcElement.setAttribute('hidden', true); // Log user response to prompt.
...
var _html5Qrcode = _interopRequireDefault(require("./html5-qrcode/html5-qrcode"));

var _html5QrcodeScanner = _interopRequireDefault(require("./html5-qrcode/html5-qrcode-scanner"));
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    this.html5QrCode = new _html5Qrcode.default("reader");
    this.options = {
  ...
  _createClass(App, [{
    ...
    value: function getCameras() {
      ...
      _html5Qrcode.default.getCameras().then(function (devices) {
        console.log(devices);
...
var app = new App();
},{"../scss/master.scss":"scss/master.scss","./html5-qrcode/html5-qrcode":"js/html5-qrcode/html5-qrcode.js","./html5-qrcode/html5-qrcode-scanner":"js/html5-qrcode/html5-qrcode-scanner.js","./install":"js/install.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
