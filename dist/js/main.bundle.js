...
/***/ "./src/js/html5-qrcode/html5-qrcode-scanner.js":
/*!*****************************************************!*\
  !*** ./src/js/html5-qrcode/html5-qrcode-scanner.js ***!
  \*****************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Html5QrcodeScanner; });
...
/***/ "./src/js/html5-qrcode/html5-qrcode.js":
/*!*********************************************!*\
  !*** ./src/js/html5-qrcode/html5-qrcode.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Html5Qrcode; });
/* harmony import */ var _qrcode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./qrcode */ "./src/js/html5-qrcode/qrcode.js");
...
var Html5Qrcode = /*#__PURE__*/function () {
  ...
  function Html5Qrcode(elementId, verbose) {
    ...
    if (!_qrcode__WEBPACK_IMPORTED_MODULE_0__["default"]) {
      throw 'Use html5qrcode.min.js without edit, getLazarSoftScanner' + 'not found.';
    }

    this.qrcode = Object(_qrcode__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getLazarSoftScanner; });
/*
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _html5_qrcode_html5_qrcode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./html5-qrcode/html5-qrcode */ "./src/js/html5-qrcode/html5-qrcode.js");
/* harmony import */ var _html5_qrcode_html5_qrcode_scanner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./html5-qrcode/html5-qrcode-scanner */ "./src/js/html5-qrcode/html5-qrcode-scanner.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    this.html5QrCode = new _html5_qrcode_html5_qrcode__WEBPACK_IMPORTED_MODULE_0__["default"]("reader");
    this.options = {
  ...
  _createClass(App, [{
    ...
    value: function getCameras() {
      ...
      _html5_qrcode_html5_qrcode__WEBPACK_IMPORTED_MODULE_0__["default"].getCameras().then(function (devices) {
        console.log(devices);
        ...
        if (devices && devices.length) {
          devices.forEach(function (device) {
            ...
            _this.options.$select.appendChild(option);
          });
        }
      })["catch"](function (err) {
        console.log(err);
...
/***/ 0:
/*!******************************************************!*\
  !*** multi ./src/js/index.js ./src/scss/master.scss ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
